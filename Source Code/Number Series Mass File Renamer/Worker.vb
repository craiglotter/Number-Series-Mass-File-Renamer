...
#End Region
    ...
    Public Sub WorkerExecute()
        Try
            ...
            Dim currentnumber As Long = seriesstart
            Dim lastnumber As Long = dinfo.GetFiles.Length
            Dim stringlength As Long = lastnumber.ToString.Length()
            ...
            For Each finfo In dinfo.GetFiles
                Try
                    ...
                    newname = currentnumber.ToString
                    While newname.Length < stringlength
                        newname = "0" & newname
                    End While
